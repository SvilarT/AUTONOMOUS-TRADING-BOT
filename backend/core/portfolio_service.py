...
class PortfolioService:
    ...
    async def record_buy_fill(self, user_id: str, symbol: str, filled_price: float, base_units: float, notional_usd: float) -> None:
    ...
    async def record_sell_fill(self, user_id: str, symbol: str, filled_price: float, base_units: float) -> Dict[str, Any]:
        positions = await self.repo.get_positions(user_id)
