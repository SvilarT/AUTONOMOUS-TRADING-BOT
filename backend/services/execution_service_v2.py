...
class ExecutionServiceV2:
    """Execution primitive with explicit buy-notional / sell-units semantics."""
    ...
    async def buy(self, symbol: str, notional_usd: float, signal_snapshot: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def sell(self, symbol: str, base_units: float, reason: str = "") -> Dict[str, Any]:
